...
import { getFirestore, collection, doc, getDoc, getDocs, setDoc, updateDoc, deleteDoc, onSnapshot, getDocFromServer, Query, DocumentReference } from 'firebase/firestore';
